...
class clsBankClient : public clsPersonM
{
private:
	...
	static vector <clsBankClient> _LoadClientsDataFromFile()
	{
		...
		fstream MyFile;
		MyFile.open("ClientsM.txt", ios::in);
	...
	{
		fstream MyFile;
		MyFile.open("ClientsM.txt", ios::out);
	...
	{
		fstream MyFile;
		MyFile.open("ClientsM.txt", ios::out | ios::app);
...
public:
	...
	clsBankClient(enMode Mode, string FirstName, string LastName, string Email, string Phone,
		string AccountNumber, string PINCode, float AccountBalance) :clsPersonM(FirstName, LastName, Email, Phone)
	{
		_Mode = Mode;
